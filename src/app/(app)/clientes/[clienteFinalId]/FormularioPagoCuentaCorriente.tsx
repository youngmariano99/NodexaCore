        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-lg border border-[#222A27] bg-[#0D1110] p-6 text-slate-50 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4">
              ...
              <div className="rounded-md bg-[#111615]/40 border border-[#222A27] px-3 py-2.5 text-xs text-slate-400 flex flex-col gap-0.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    disabled={isPending}
                    className="w-full rounded-md border border-[#222A27] bg-[#111615] pl-7 pr-4 py-2 text-sm text-slate-100 placeholder-slate-500 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none font-mono"
                  />
                </div>
              </div>
