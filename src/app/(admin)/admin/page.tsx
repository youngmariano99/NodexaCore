    ...
    <div className="flex flex-1 flex-col bg-slate-950 px-6 py-10 text-slate-50">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        ...
        <section className="grid gap-6 sm:grid-cols-3">
          <div className="rounded-lg border border-slate-800 bg-slate-900/30 p-5 flex flex-col gap-2">
          ...
          <div className="rounded-lg border border-slate-800 bg-slate-900/30 p-5 flex flex-col gap-2">
            ...
            <span className="text-3xl font-bold font-mono text-emerald-400">{activos}</span>
          </div>
          <div className="rounded-lg border border-slate-800 bg-slate-900/30 p-5 flex flex-col gap-2">
        ...
        <section className="flex flex-col gap-4 mt-4">
          <h2 className="text-sm font-semibold text-slate-400 uppercase tracking-wider">Herramientas del Sistema</h2>
          
          <div className="grid gap-4 sm:grid-cols-2">
            {/* Alta de Comercio */}
            <Link
              href="/admin/clientes/nuevo"
              className="flex items-center justify-between p-5 rounded-lg border border-slate-800 bg-slate-900/40 hover:bg-slate-900 hover:border-slate-700 transition-all group"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-200">Alta de Comercio</span>
                  <span className="text-xs text-slate-400">Registrar nuevo local y configurar módulos</span>
                </div>
              </div>
              <ArrowRight className="h-4 w-4 text-slate-500 group-hover:text-slate-200 group-hover:translate-x-1 transition-all" />
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-200">Control de Morosidad</span>
            ...
            <Link
              href="/admin/clientes"
              className="flex items-center justify-between p-5 rounded-lg border border-slate-800 bg-slate-900/40 hover:bg-slate-900 hover:border-slate-700 transition-all group sm:col-span-2"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-semibold text-slate-200">Listado General de Comercios</span>
