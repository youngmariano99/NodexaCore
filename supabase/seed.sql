...
BEGIN
  ...
  INSERT INTO usuarios (usuario_id, auth_user_id, cliente_id, rol, nombre, email) VALUES
    ('d0000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000001', NULL, 'admin_nodexa', 'Soporte Nodexa', 'admin@nodexa.app'),
    ('d0000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000002', 'a1111111-1111-4111-8111-111111111111', 'comerciante', 'Pedro Almacenero', 'pedro@almacendonpedro.com'),
    ('d0000000-0000-4000-8000-000000000003', '00000000-0000-0000-0000-000000000003', 'a1111111-1111-4111-8111-111111111111', 'empleado', 'Carlos Empleado', 'carlos@almacendonpedro.com'),
    ('d0000000-0000-4000-8000-000000000004', '00000000-0000-0000-0000-000000000004', 'b2222222-2222-4222-8222-222222222222', 'comerciante', 'Roberto Ferretero', 'roberto@eltornillo.com'),
    ('d0000000-0000-4000-8000-000000000005', '00000000-0000-0000-0000-000000000005', 'b2222222-2222-4222-8222-222222222222', 'empleado', 'Ana Ayudante', 'ana@eltornillo.com'),
    ('d0000000-0000-4000-8000-000000000006', '00000000-0000-0000-0000-000000000006', 'c3333333-3333-4333-8333-333333333333', 'comerciante', 'Andrés Bazares', 'andres@bazarcasasur.com'),
    ('d0000000-0000-4000-8000-000000000007', '00000000-0000-0000-0000-000000000007', 'c3333333-3333-4333-8333-333333333333', 'empleado', 'Lucía Ventas', 'lucia@bazarcasasur.com'),
    ('d0000000-0000-4000-8000-000000000010', '00000000-0000-0000-0000-000000000010', 'a0000000-0000-4000-8000-000000000000', 'comerciante', 'Demo Owner', 'demo@nodexa.app');
