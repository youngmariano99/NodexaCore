...
BEGIN
  ...
  INSERT INTO tenant_modules (cliente_id, modulo, activo) VALUES
    ...
    ('a1111111-1111-4111-8111-111111111111', 'catalogo_web', false),
    ('a1111111-1111-4111-8111-111111111111', 'carga_ia', false),
    ...
    ('b2222222-2222-4222-8222-222222222222', 'catalogo_web', false),
    ...
    ('c3333333-3333-4333-8333-333333333333', 'carga_ia', true),
  ...
  INSERT INTO marcas (marca_id, cliente_id, nombre) VALUES
    ('fa000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000000', 'Coca Cola'),
    ('fa000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000000', 'Arcor'),
    ('fa000000-0000-4000-8000-000000000003', 'a1111111-1111-4111-8111-111111111111', 'La Serenísima'),
  ...
  -- ------------------------------------------------------------
  -- 6. PRODUCTOS Y STOCK BASE (Tenants A, B y C con fixtures para RLS)
  -- ------------------------------------------------------------
  INSERT INTO productos (
    ...
    ('e2222222-2222-4222-8222-222222222223', 'b2222222-2222-4222-8222-222222222222', 'Termo Acero Inoxidable 1L', 'HER-202', 45000, 8, 3, true, NULL, 'Bazar', 'fa000000-0000-4000-8000-000000000004', 'fb000000-0000-4000-8000-000000000003'),
